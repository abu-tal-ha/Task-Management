  ...
  return (
    <>
      <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
        ...
        <Table.Cell>
          <button onClick={() => setOpenModal(true)} className="font-medium text-red-600 hover:underline dark:text-red-500 mr-3">
            Edit
          </button>
          <button onClick={() => props.onDelete(id)}  className="font-medium text-cyan-600 hover:underline dark:text-cyan-500">
            Delete
          </button>
        </Table.Cell>
      </Table.Row>
